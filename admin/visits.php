...
<html lang="en">
	...
	<body>
		<div id="wrapper">
			<?php $select = 1; include_once($_SERVER['DOCUMENT_ROOT']."/libraryattendance/includes/adminNav.php"); ?>
			<div id="page-wrapper">
				<h1>Visits</h1>
				<hr>
				<div class="container">
						...
						<div class="panel panel-default">
							<div class="panel-body">
								<?php
									...
									include_once($_SERVER['DOCUMENT_ROOT']."/libraryattendance/includes/tableHead.php");
